...
async def initialize_sk_memory_store(
    ...
    try:
        ...
        logging.info("AZCOSMOS_CONNSTR:" + os.environ.get("AZCOSMOS_CONNSTR") or "connection-string")
        ...
        logging.info("num_lists:" + str(num_lists))
        logging.info("vector_dimensions:" + str(vector_dimensions))
